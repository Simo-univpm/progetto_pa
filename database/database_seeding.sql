...
CREATE TABLE db_transazioni(
  ...
  fonte_produzione VARCHAR(50) NOT NULL,
  data_acquisto_transazione TIMESTAMP WITH TIME ZONE NOT NULL,
  data_prenotazione_transazione TIMESTAMP WITH TIME ZONE NOT NULL
);
...
INSERT INTO db_producer (nome, email, passwd, fonte_produzione, emissioni_co2, privilegi, slot_0, slot_1, slot_2, slot_3, slot_4, slot_5, slot_6, slot_7, slot_8, slot_9, slot_10, slot_11, slot_12, slot_13, slot_14, slot_15, slot_16, slot_17, slot_18, slot_19, slot_20, slot_21, slot_22, slot_23, data_registrazione, accetta_taglio_richieste)
VALUES 
--// id_p, nome,              email,                  passwd,                                                           fonte_prod,     emis_co2, privilegi,   slot_0('costo slot', 'tetto_massimo', 'rimanente')           slot_1('costo slot', 'tetto_massimo', 'rimanente')           slot_2('costo slot', 'tetto_massimo', 'rimanente')           slot_3('costo slot', 'tetto_massimo', 'rimanente')           slot_4('costo slot', 'tetto_massimo', 'rimanente')           lot_5('costo slot', 'tetto_massimo', 'rimanente')            slot_6('costo slot', 'tetto_massimo', 'rimanente')           slot_7('costo slot', 'tetto_massimo', 'rimanente')           slot_8('costo slot', 'tetto_massimo', 'rimanente')           slot_9('costo slot', 'tetto_massimo', 'rimanente')           slot_10('costo slot', 'tetto_massimo', 'rimanente')          slot_11('costo slot', 'tetto_massimo', 'rimanente')          slot_12('costo slot', 'tetto_massimo', 'rimanente')          slot_13('costo slot', 'tetto_massimo', 'rimanente')          slot_14('costo slot', 'tetto_massimo', 'rimanente')          slot_15('costo slot', 'tetto_massimo', 'rimanente')          slot_16('costo slot', 'tetto_massimo', 'rimanente')          slot_17('costo slot', 'tetto_massimo', 'rimanente')          slot_18('costo slot', 'tetto_massimo', 'rimanente')          slot_19('costo slot', 'tetto_massimo', 'rimanente')           slot_20('costo slot', 'tetto_massimo', 'rimanente')          slot_21('costo slot', 'tetto_massimo', 'rimanente')          slot_22('costo slot', 'tetto_massimo', 'rimanente')          slot_23('costo slot', 'tetto_massimo', 'rimanente')          data_registrazione,          accetta_taglio_richieste)
   ...
   --('EnergyLowCost',    'lowcost@lowcost.it',   '$2a$10$/Lj.Ldf5jA9Hg.qcGqR3kuxsXCzAtpoJpVwwTHCu3ogyHGJrTXjP2',   'fossile',      2,        1, 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', '2022-07-19 14:59:14.37+00',True);


INSERT INTO db_admin(nome, email, passwd, privilegi, data_registrazione)
VALUES
--  id_a,     nome,      email,       passwd,                                               priv, data_registrazione
    ('admin_1', 'admin_1@admin_1.it', '$2a$10$fyOSf9cCrnpwTXTTj5.7DeZy.3vJDdbhy1PAlfOmzST5o3TqZ2dqe',0,  '2022-07-19 14:49:54.247+00');
