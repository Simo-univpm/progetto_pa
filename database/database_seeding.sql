...
VALUES
--  nome,         email,                    passwd,                                                        credito,  privilegi, data_registrazione
...
VALUES 
-- nome,                 email,                  passwd,                                                          fonte_prod,     emis_co2, privilegi,         slot_0('costo slot', 'tetto_massimo', 'rimanente')           slot_1('costo slot', 'tetto_massimo', 'rimanente')           slot_2('costo slot', 'tetto_massimo', 'rimanente')           slot_3('costo slot', 'tetto_massimo', 'rimanente')           slot_4('costo slot', 'tetto_massimo', 'rimanente')           slot_5('costo slot', 'tetto_massimo', 'rimanente')            slot_6('costo slot', 'tetto_massimo', 'rimanente')           slot_7('costo slot', 'tetto_massimo', 'rimanente')           slot_8('costo slot', 'tetto_massimo', 'rimanente')           slot_9('costo slot', 'tetto_massimo', 'rimanente')           slot_10('costo slot', 'tetto_massimo', 'rimanente')          slot_11('costo slot', 'tetto_massimo', 'rimanente')          slot_12('costo slot', 'tetto_massimo', 'rimanente')          slot_13('costo slot', 'tetto_massimo', 'rimanente')          slot_14('costo slot', 'tetto_massimo', 'rimanente')          slot_15('costo slot', 'tetto_massimo', 'rimanente')          slot_16('costo slot', 'tetto_massimo', 'rimanente')          slot_17('costo slot', 'tetto_massimo', 'rimanente')          slot_18('costo slot', 'tetto_massimo', 'rimanente')          slot_19('costo slot', 'tetto_massimo', 'rimanente')           slot_20('costo slot', 'tetto_massimo', 'rimanente')          slot_21('costo slot', 'tetto_massimo', 'rimanente')          slot_22('costo slot', 'tetto_massimo', 'rimanente')          slot_23('costo slot', 'tetto_massimo', 'rimanente')      data_registrazione,        accetta_taglio_richieste)
...
VALUES
--    id_cons,  id_prod, em_co2,    $_slot,     kw_acq,     slot_n,  fonte,      data_acq,                      data_slot_pren
